    ...
    return html`
      ...
      <div class="row-layout header">
        <div class="row-layout group">
          ...
          <igc-button variant="flat" @click=${() => this.projectDropdown?.toggle(this.button)} id="button" class="button button_2">
            <span>Home</span>
          ...
          <igc-dropdown id="project-dropdown" class="project-dropdown project-dropdown_1">
            <igc-dropdown-item>
              Home
            </igc-dropdown-item>
            <igc-dropdown-item>
        ...
        <div class="row-layout group_1">
          <igc-button @click=${() => this.section?.toggle(this.button1)} id="button-1" class="button_1 button_1_1">
            <span class="material-icons">
              add
            </span>
            <span>Task</span>
