    ...
    return html`
      ...
      <div class="column-layout left_nav">
        ...
        <div class="column-layout group_1">
          ...
          <igc-button variant="flat" class="button button_5">
      ...
      <div class="column-layout content_section">
        <div class="row-layout content_toolbar">
          ...
          <igc-button variant="flat" class="button_1 button_1_1">
            <span class="material-icons">
              list
            </span>
            <span>LIST</span>
          ...
          <igc-button variant="flat" class="button_2 button_2_1">
            <span class="material-icons">
              calendar_view_day
            </span>
            <span>SECTION</span>
          ...
          <igc-button variant="flat" class="button_2 button_2_2">
            <span class="material-icons">
              dns
            </span>
            <span>FIELDS</span>
